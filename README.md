# My Personal Page
 ...
 This repository contains the code to establish a personal webpage for Chenghao Xu with Github Pages.  This project is derived from the work [al-folio](https://github.com/alshedivat/al-folio).


### Modifications
- The **Featured Projects** section is developed on [Isotope Filter & sort layouts](https://isotope.metafizzy.co/), which can achieve can achieve dynamic exhibitions on target projects.

- The **Experience** section is built on a dynamic vertical timeline, which exhabits contents with folding details.

### Installation
- Assuming you have installed [rbenv](https://github.com/rbenv/rbenv) (*for ease of managing ruby gems*), first install [Ruby](https://www.ruby-lang.org/en/downloads/) and [Bundler](https://bundler.io/) on your system:
  ```bash
  $ rbenv install --list # check available ruby version
  $ rbenv install 2.7.1  # install ruby 2.7.1 in rbenv
  $ rbenv global 2.7.1   # setup global version
  $ gem install bundler  # install bundler
  ```
  > Hint: run `which ruby` to check current ruby directory, which should be "~/.rbenv/shims/ruby".



- Run following to view the deployed website: 
  ```bash
  $ git clone git@github.com:Kyle-Xu001/kyle-xu001.github.io.git
  $ cd kyle-xu001.github.io.git
  $ bundle install
  $ bundle exec jekyll serve [--port 4000] # optional port variable
  ```
----------
----------
